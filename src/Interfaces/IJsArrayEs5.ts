namespace ts {
    /**
     * **`IJsArrayEs5<T>`** is a *generic interface* that ***exposes*** [**`ES5`**](https://www.w3schools.com/js/js_es5.asp)
     ...
     * *source library* [**`lib.es5.d.ts`**](https://github.com/microsoft/TypeScript/blob/master/lib/lib.es5.d.ts).
     **/
    export interface IJsArrayEs5<T> {
        ...
        /**
         * Gets or sets the data value of the array, at the specified zero-based index location.
         **/
        [index: number]: T;
        ...
        /**
         * Sorts an array.
         * @param compareFn Function used to determine the order of the elements. It is expected to return a negative value
         * if first argument is less than second argument, zero if they're equal and a positive value otherwise. If omitted,
         ...
         * @param callbackfn A function that accepts up to three arguments. The every method calls the callbackfn function
         * for each element in the array until the callbackfn returns a value which is coercible to the Boolean value false,
         ...
         * @param callbackfn A function that accepts up to three arguments. The some method calls the callbackfn function
         * for each element in the array until the callbackfn returns a value which is coercible to the Boolean value true,
         * or until the end of the array.
         * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted,
         * undefined is used as the this value.
         **/
         ...
         * undefined is used as the this value.
         **/
        filter<S extends T>(callbackfn: (value: T, index: number, array: Array<T>) => value is S, thisArg?: any): Array<S>;
         ...
         * undefined is used as the this value.
         **/
        filter(callbackfn: (value: T, index: number, array: Array<T>) => unknown, thisArg?: any): Array<T>;
         ...
         * @param callbackfn A function that accepts up to four arguments. The reduceRight method calls the callbackfn function
         * one time for each element in the array.
         * @param initialValue If initialValue is specified, it is used as the initial value to start the accumulation.
         * The first call to the callbackfn function provides this value as an argument instead of an array value.
         **/
